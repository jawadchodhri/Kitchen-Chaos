...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    private void HandleIntractions()
    {
        ...
        if (Physics.Raycast(transform.position, lastInteractDir, out rayCastHit, intractDistance, counterLayerMask))
        {
    ...
    private void HanddleMovement()
    {
        ...
        if (canMove == false)
        {
            ...
            {
                //can't move only in the x direction

                //will only move in the z direction
